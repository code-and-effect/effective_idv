...
Gem::Specification.new do |spec|
  spec.name        = 'effective_idv'
  spec.version     = EffectiveIdv::VERSION
  spec.authors     = ['Code and Effect']
  spec.email       = ['info@codeandeffect.com']
  spec.homepage    = 'https://github.com/code-and-effect/effective_idv'
  spec.summary     = 'Online identity verification with encrypted uploads'
  spec.description = 'Online identity verification with encrypted uploads'
  spec.license     = 'MIT'
